...
* **Sistema de Progresión:** Tres niveles de dificultad temática:  
  1. **Vehículos Terrestres:** (Desbloqueado por defecto) 🚗  
  2. **Vehículos Marítimos:** (Se desbloquea tras superar el Nivel 1\) 🚢  
  3. **Vehículos Aéreos:** (Se desbloquea tras superar el Nivel 2\) ✈️  
